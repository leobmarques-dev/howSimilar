...
window.onload=function(){
    ...
    // DEPENDENCIAS =================================
    var scriptDep = document.createElement('script');
    scriptDep.type = "text/javascript";
    scriptDep.src = "js/test1.js";
    document.head.appendChild(scriptDep);
    var scriptDep2 = document.createElement('script');
    scriptDep2.src = "js/test2.js";
    document.head.appendChild(scriptDep2);
...
// -----------------------------------------------------------------------------------------------------------
            ...
            // var saidaProPanel = saidaResultadoAnalise;
